...
const Transactions = () => {
	// we can fetch this data from an API
	...
	return (
		<div className="flex flex-col items-start gap-5">
			...
			<div className="p-3 pb-6 bg-white rounded-lg w-full flex flex-col gap-3">
				{/* // we can pass data and setter function as props to FilterData component */}
				<FilterData data={data} />

				{/* // we can pass data as props to DataTable component to display data*/}
				<DataTable data={data} />
